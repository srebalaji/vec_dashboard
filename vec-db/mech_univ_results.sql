...
--
-- Table structure for table `mech_univ_results`
--
...
--
-- Constraints for table `mech_univ_results`
--
ALTER TABLE `mech_univ_results`
  ADD CONSTRAINT `qq` FOREIGN KEY (`rollno`) REFERENCES `mech_master` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
